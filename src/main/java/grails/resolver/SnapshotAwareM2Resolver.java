    ...
    private ResolvedResource findSnapshotArtifact(Artifact artifact, Date date,
        ...
        if (rev != null) {
            ...
            if (uniqueResource != null) {
                return new FixedLastModifiedResolvedResource(uniqueResource.getResource(), rev.uniqueRevision, rev.lastModified);
            } else {
                ...
                if (nonUnique != null) {
                    return new FixedLastModifiedResolvedResource(nonUnique.getResource(), rev.revision, rev.lastModified);
                }
            }
        }
        return null;
